function [traj, infStates] = tapas_ehgf_ar1_binary_pu(r, p, varargin)
% Calculates the trajectories of the agent's representations under the HGF
% *with* perceptual uncertainty
%
% This function can be called in two ways:
% 
% (1) tapas_ehgf_ar1_binary(r, p)
%   
%     where r is the structure generated by tapas_fitModel and p is the parameter vector in native space;
%
% (2) tapas_ehgf_ar1_binary(r, ptrans, 'trans')
% 
...
if ~isempty(varargin) && strcmp(varargin{1},'trans')
    p = tapas_ehgf_ar1_binary_pu_transp(r, p);
end
