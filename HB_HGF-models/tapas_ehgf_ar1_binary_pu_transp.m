function [pvec, pstruct] = tapas_ehgf_ar1_binary_pu_transp(r, ptrans)
% --------------------------------------------------------------------------------------------------
...
pstruct.al        = pvec(6*l);
pvec(6*l+1)       = ptrans(6*l+1);                         % eta0
pstruct.eta0      = pvec(6*l+1);
pvec(6*l+2)       = ptrans(6*l+2);                         % eta1
pstruct.eta1      = pvec(6*l+2);
