function c = tapas_logrt_linear_binary_val_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_logrt_linear_binary_val';
...
% Zeta
c.logzemu = log(log(10)); % log(log(20))
c.logzesa = log(2);
...
% Model filehandle
c.obs_fun = @tapas_logrt_linear_binary_val;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @tapas_logrt_linear_binary_val_transp;
