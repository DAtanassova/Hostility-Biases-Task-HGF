function c = tapas_ehgf_ar1_binary_pu_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% Note that in the absence of sensory uncertainty, the first
...
%
%   >> est = tapas_fitModel([], u, 'tapas_ehgf_binary_pu_config', 'tapas_bayes_optimal_binary_config');
%
...
c.logitphimu = [NaN, tapas_logit(0.5,1), tapas_logit(0.5,1)];%tapas_logit(0.1,1)
c.logitphisa = [NaN,    2,                  0];
...
expectedLength = 5*c.n_levels+1*(c.n_levels-1)+3;
...
c.prc_fun = @tapas_ehgf_ar1_binary_pu;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_ehgf_ar1_binary_pu_transp;
